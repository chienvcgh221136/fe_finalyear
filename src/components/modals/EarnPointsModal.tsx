            ...
            <div className="bg-white rounded-3xl w-full max-w-2xl relative z-10 overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-300">
                <div className="bg-gradient-to-r from-red-600 to-rose-600 p-8 text-white relative overflow-hidden">
                    <div className="relative z-10">
                        ...
                        <p className="text-red-100">Hoàn thành các nhiệm vụ bên dưới để nhận điểm thưởng hấp dẫn.</p>
                    </div>
                    {/* Decorative */}
                ...
                <div className="p-8 max-h-[70vh] overflow-y-auto">
                    ...
                    <button
                        onClick={onClose}
                        className="w-full mt-8 bg-gray-100 text-gray-700 font-bold py-4 rounded-xl hover:bg-gray-200 transition"
                    >
                        Đã hiểu
                    </button>
                </div>
